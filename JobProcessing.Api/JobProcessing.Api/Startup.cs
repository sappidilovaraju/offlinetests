...
using JobProcessing.Api.Infrastructure.Extensions;
using JobProcessing.Api.Mediator.Configuration;
...
namespace JobProcessing.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "JobProcessing.Api ASP.NET Core API v1");
            });
